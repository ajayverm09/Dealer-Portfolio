    ...
    <div className="bg-[#fafae7]">
      ...
      <div className="min-h-screen p-6 md:p-16">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-10">Find Your Dream Home</h1>

          <div className="grid md:grid-cols-2 gap-10 items-start">
            <img
              src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c"
              alt="Property A"
              className="w-full h-[450px] object-cover rounded-lg shadow-lg transition-transform duration-300 hover:-translate-y-1"
            />
            <div>
              <h2 className="text-2xl font-semibold mb-2">Property A</h2>
              <h3 className="text-lg font-medium text-gray-700 mb-4">Exclusive Property</h3>
      ...
      <div className="min-h-screen p-6 md:p-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-start">
            <div>
              <h2 className="text-2xl font-semibold mb-2">Property B</h2>
              <h3 className="text-lg font-medium text-gray-700 mb-4">Exclusive Property</h3>
              <p className="text-gray-800 leading-relaxed">
                Explore our exclusive range of luxurious properties that cater to your refined taste and lifestyle.
                From elegant penthouses to waterfront mansions, our luxury homes embody sophistication and comfort —
      ...
      <div className="min-h-screen p-6 md:p-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-start">
            ...
            />
            <div>
              <h2 className="text-2xl font-semibold mb-2">Property C</h2>
              <h3 className="text-lg font-medium text-gray-700 mb-4">Exclusive Property</h3>
              <p className="text-gray-800 leading-relaxed">
                Explore our exclusive range of luxurious properties that cater to your refined taste and lifestyle.
                From elegant penthouses to waterfront mansions, our luxury homes embody sophistication and comfort —
      ...
      <div className="min-h-screen p-6 md:p-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-start">
            <div>
              <h2 className="text-2xl font-semibold mb-2">Property D</h2>
              <h3 className="text-lg font-medium text-gray-700 mb-4">Exclusive Property</h3>
              <p className="text-gray-800 leading-relaxed">
                Explore our exclusive range of luxurious properties that cater to your refined taste and lifestyle.
                From elegant penthouses to waterfront mansions, our luxury homes embody sophistication and comfort —
